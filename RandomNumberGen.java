...
public class RandomNumberGen {
	public static void main(String[] args) {
		//Asks you about what you want your password to have and it's length, as well as printing and declaring variables
		...
		System.out.println("Would you like random symbols for some security? (True/False)");
		String WantsSymbols = Scan.nextLine();
		System.out.println("Would you like random special symbols for maximum security? (True/False)");
		String WantsSpecialSymbols = Scan.nextLine();
		for (int i = 0; i < Amount; i += 1) {
				...
				if (WantsSymbols.equalsIgnoreCase("True")) {
					...
					else if (doDecimal == 1) {Password.append("@"); didSymbol = true;}//Every special symbol you can choose to have in the password
				...
				if (WantsSpecialSymbols.equalsIgnoreCase("True")) {
					if (doDecimal == 19) {Password.append("∞"); didSymbol = true;}//
				...
				if (didSymbol == true) {
					didSymbol = false;
						...
						int PickLetter = Random.nextInt(62);
						//////////////////////////////////////////////////
						if (PickLetter == 0) {Password.append("A");}//All uppercase letters
						...
						////////////////////////////////////////////////////////
						else if (PickLetter == 26) {Password.append("a");}//All lowercase letters
						...
						else if (PickLetter == 52) {Password.append("0");}//Numbers
						else if (PickLetter == 53) {Password.append("1");}//
						else if (PickLetter == 54) {Password.append("2");}//
						else if (PickLetter == 55) {Password.append("3");}//
						else if (PickLetter == 56) {Password.append("4");}//
						else if (PickLetter == 57) {Password.append("5");}//
						else if (PickLetter == 58) {Password.append("6");}//
						else if (PickLetter == 59) {Password.append("7");}//
						else if (PickLetter == 60) {Password.append("8");}//
						else if (PickLetter == 61) {Password.append("9");}//
				}
			}
